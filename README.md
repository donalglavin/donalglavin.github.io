# Introduction. 
This repository contains the raw content for my personal blog/portfolio. 
The blog is generated using Hugo, a fast and flexible static site generator.

And through the use of github actions its compiled and published.
You can view the blog/portfolio: [donalglavin.github.io](https://donalglavin.github.io)

As the objective of this portfolio is for sharing information and knowledge on the basis 
of donations rather than fees. I've created the following list of instructions to help 
others learn and develop their skills in the hope that more people are willing to share 
their learnings and knowledge.

# Overview. 
This guide will walk you through the steps of creating your Hugo-powered blog, 
...
- A GutHub account. (free to sign up for personal use). 
- A Computer with the ability to install software.
- Git (an application, different from GitHub).
- Hugo (The tool used to build static sites). 
- *(optional)* a Markdown editor of your choosing.
...
- If you're usinf Linux (I trust you probably didn't read this).
